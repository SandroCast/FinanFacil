...
Future<List<BuscaLancamentosRow>> performBuscaLancamentos(
  ...
  final query = '''
SELECT lancamentos.id, descricao, valor, fixo, tipo_transacao as avista, parcela, total_parcelas as totalparcelas, status, tipo, dt_agendada AS dtagendada, id_parcela as idparcela FROM lancamentos
